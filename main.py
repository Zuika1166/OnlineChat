...
async def main():
    ...
    put_markdown('## Добро положовать, чат хранит до 100 сообщений\nХотите больше ? - покупайте подписку')
    toast('Сайт создан - @mpz36')
    msg_box = output()
    ...
    put_buttons(['Перейти'], onclick=lambda btn: run_js('window.location.reload('))
